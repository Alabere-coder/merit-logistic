...
// import { updateBrandingSettings } from "@/lib/actions/branding-settings";
...
//   settings: BrandingSettings;
// }) {
//   const [state, formAction] = useActionState(updateBrandingSettings, {});
...
//           name="tagline"
//           defaultValue={settings.tagline ?? ""}
//           placeholder="Moving your world forward"
//           maxLength={150}
//         />
...
//           <p className="text-xs text-slate-400">
//             Main color used for buttons, links, and important actions.
//           </p>
//         </div>
...
//           <p className="text-xs text-slate-400">
//             Supporting color used for secondary elements and gradients.
//           </p>
//         </div>
//       </div>
...
//               Your browser favicon will be managed separately through Supabase
//               Storage. We will add the upload functionality next.
//             </p>

//             {settings.favicon_url && (
//               <p className="mt-2 break-all text-xs text-slate-400">
//                 Current favicon: {settings.favicon_url}
//               </p>
//             )}
//           </div>
//         </div>
