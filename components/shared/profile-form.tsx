...
function SubmitButton() {
  ...
  return (
    <Button
      type="submit"
      disabled={pending}
      className="w-full bg-linear-to-r from-blue-600 to-indigo-600 text-white font-semibold shadow-md transition-all hover:from-blue-700 hover:to-indigo-700 hover:shadow-lg disabled:opacity-50"
    >
      {pending ? (
        <>
...
export function ProfileForm({
  ...
  return (
    <div className="overflow-hidden border-slate-200/80 shadow-sm transition-all hover:shadow-md">
      <div className="pt-6">
