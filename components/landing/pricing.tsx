    ...
    <section id="pricing" className="bg-navy-50 py-20">
      <div className="container-lg">
        <div className="mx-auto max-w-xl text-center">
          ...
          <h2 className="mt-3 font-display text-3xl font-700 text-navy-900">
            ...
            >
              ...
              <h3
                className={cn(
                  ...
                  p.highlighted ? "text-white" : "text-navy-900",
                )}
              >
                {p.name}
              </h3>
              <div className="mt-3 flex items-baseline gap-1.5">
                ...
                <span
                  className={cn(
                    "text-sm",
                    p.highlighted ? "text-navy-300" : "text-navy-400",
                  )}
                >
                  {p.unit}
                </span>
                  ...
                  <li key={f} className="flex items-start gap-2.5 text-sm">
                    <Check
                      className={cn(
                        ...
                        p.highlighted ? "text-brand-500" : "text-brand-600",
                      )}
                    />
                    <span
                      className={
                        p.highlighted ? "text-navy-200" : "text-navy-600"
                      }
                    >
                      {f}
                    </span>
