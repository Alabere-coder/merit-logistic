...
export default async function DriverDeliveryDetailPage({
  ...
  /* -------------------------------------------------------
     Get driver's database ID and current location
  ------------------------------------------------------- */
  ...
  /* -------------------------------------------------------
     ...
     lat/lng are used by the tracking map to display
     historical shipment locations.
  ------------------------------------------------------- */
  ...
  /* -------------------------------------------------------
     Prepare current driver location for the map
  ------------------------------------------------------- */
    ...
    <div className="mx-auto max-w-5xl space-y-8 px-4 py-8">
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <Card className="overflow-hidden border-indigo-100/80 shadow-sm transition-all hover:shadow-md">
            ...
            <CardContent className="p-6">
              <div className="relative space-y-6 pl-6 before:absolute before:bottom-3 before:left-2 before:top-3 before:w-0.5 before:bg-linear-to-b before:from-blue-500 before:to-emerald-500">
                {/* Pickup */}
                <div className="relative space-y-1">
                  <span className="absolute -left-6 top-1 h-3 w-3 rounded-full border-2 border-white bg-blue-600 ring-4 ring-blue-100" />
                ...
                {/* Delivery */}
                <div className="relative space-y-1">
                  <span className="absolute -left-6 top-1 h-3 w-3 rounded-full border-2 border-white bg-emerald-600 ring-4 ring-emerald-100" />
          ...
          <Card className="overflow-hidden border-slate-200/80 shadow-sm">
            <CardHeader className="border-b border-slate-100 bg-slate-50/60 px-6 py-4">
              ...
              <p className="mt-1 text-xs text-slate-500">
                Your current location and recorded shipment locations.
              </p>
            </CardHeader>
          ...
          <Card className="overflow-hidden border-blue-100/80 shadow-sm">
            <CardHeader className="border-b border-blue-100 bg-blue-50/50 px-6 py-4">
              ...
              <p className="mt-1 text-xs text-slate-500">
                Share your current location so shipment tracking can stay up to
                date.
              </p>
            </CardHeader>
        ...
        <div className="space-y-6">
          {/* Sender Information */}
          <Card className="overflow-hidden border-blue-100/80 bg-linear-to-b from-blue-50/30 to-white shadow-sm">
          ...
          <Card className="overflow-hidden border-purple-100/80 bg-linear-to-b from-purple-50/30 to-white shadow-sm">
          ...
          <Card className="overflow-hidden border-slate-200/80 shadow-sm">
            ...
            <CardContent className="divide-y divide-slate-100 p-0 text-xs">
              ...
              <div className="flex items-center justify-between bg-linear-to-r from-emerald-50/80 to-teal-50/40 px-5 py-4">
